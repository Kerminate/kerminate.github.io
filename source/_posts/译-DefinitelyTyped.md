---
title: '[译] DefinitelyTyped'
date: 2019-06-05 15:27:32
tags: 翻译
categories: 翻译
---
最近在使用 TypeScript 的时候，发现所有 npm 包上的类型定义都在 [DefinitelyTyped](https://github.com/DefinitelyTyped/DefinitelyTyped) 这里。看了下它的 README，感觉写的有点晦涩，又发现已经有韩语，西班牙语和俄罗斯语的 README。所有，我打算给开源社区一点帮助，就译了这篇 README，并提了 PR，目前已经被仓库合并。
